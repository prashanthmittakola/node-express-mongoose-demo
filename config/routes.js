...
const postComments = require("../app/controllers/postComments");
...
const postCommentAuth = [auth.requiresLogin, auth.postComment.hasAuthorization]
...
module.exports = function(app, passport) {
  ...
  app.get('/posts/:postId/edit', postAuth, posts.edit);
  app.put('/posts/:postId', postAuth, posts.update);
  app.delete('/posts/:postId', postAuth, posts.destroy);

  // posts comment routes
  app.param('postCommentId', postComments.load);
  app.post('/posts/:postId/comments', auth.requiresLogin, postComments.create);
  app.get('/posts/:postId/comments', auth.requiresLogin, postComments.create);
  app.delete('/posts/:postId/comments/:postCommentId', postCommentAuth, postComments.destroy);
